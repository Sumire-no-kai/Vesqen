...
| `B-Web-ZH.dc.html` | B · 纸与声 | 官网首屏（中文） | 1440 × 1024 |
| `B-Sitemap.dc.html` | B · 纸与声 | 官网页面结构 | 1600 × 1060 |
| `B-Now.dc.html` | B · 纸与声 | 正在播放（中文） | 390 × 844 |
| `B-Library.dc.html` | B · 纸与声 | 曲库（中文） | 390 × 844 |
| `B-Chain.dc.html` | B · 纸与声 | 链路（中文） | 390 × 844 |
| `B-Settings.dc.html` | B · 纸与声 | 设置（中文） | 390 × 844 |
...
| `B-Settings-Dark.dc.html` | B · 纸与声 | 设置，深色（中文） | 390 × 844 |
